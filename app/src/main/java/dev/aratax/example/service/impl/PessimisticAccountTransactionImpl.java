...
@Service(PessimisticAccountTransactionImpl.BEAN_ID)
public class PessimisticAccountTransactionImpl implements AccountTransaction {

    public static final String BEAN_ID = "pessimisticAccountTransactionImpl";
    ...
    public TransactionResponse execute(UUID id, TransactionType type, BigDecimal amt, String reason) {
        var account = accountRepo.findForUpdate(id).orElseThrow();
